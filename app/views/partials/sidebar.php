...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-top">
        ...
        <nav class="menu">
            <a href="/dashboard" class="menu-item<?= isActivePage('dashboard', $activePage) ?>">
                <i class="fa-solid fa-table-columns"></i>
                <span>Dashboard</span>
            </a>

            <a href="/data-entry" class="menu-item<?= isActivePage('data-entry', $activePage) ?>">
                <i class="fa-regular fa-file-lines"></i>
                <span>Data Entry</span>
            </a>

            <?php if (AuthHelper::isAdmin()): ?>
                <a href="/user-management" class="menu-item<?= isActivePage('user-management', $activePage) ?>">
